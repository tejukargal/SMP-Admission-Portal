...
import { RESULT_COLUMN_GROUPS, type ResultColumnDef, type ResultColumnKey } from '../../utils/resultColumns';

interface ResultColumnPickerDropdownProps {
...
export function ResultColumnPickerDropdown({ columns, selected, onChange }: ResultColumnPickerDropdownProps) {
  ...
  function toggle(key: ResultColumnKey) {
      ...
      {open && createPortal(
        ...
        >
          ...
          <div className="overflow-y-auto py-1">
            {RESULT_COLUMN_GROUPS.map((group) => {
