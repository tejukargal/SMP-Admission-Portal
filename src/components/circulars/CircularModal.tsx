...
export function CircularModal({ circular, onClose }: CircularModalProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6">
      ...
      >
        {/* Fixed header */}
        <div className={`${meta.cardBg} border-b border-gray-200 px-4 sm:px-5 py-3.5 shrink-0`}>
        ...
        <div className="flex-1 overflow-y-auto px-4 sm:px-5 py-4 space-y-4">
          <div>
            ...
            <p className={`text-sm font-semibold ${meta.text}`}>{circular.subject}</p>
          </div>
