...
export function ImportFeeStructure() {
      ...
      {importResults && (
        <div className="space-y-3">
          ...
          <button
            ...
            className="px-3 py-1.5 text-xs rounded border border-gray-300 bg-white hover:bg-gray-50 cursor-pointer transition-colors"
          >
            Import Another File
          </button>
        </div>
