...
export const DEPARTMENTS: Record<Department, DepartmentMeta> = {
  ...
  'EC': {
    ...
    cardBg: 'bg-orange-50/60', borderL: 'border-l-orange-500', text: 'text-orange-700',
  },
  'EE': {
    ...
    cardBg: 'bg-red-50/60', borderL: 'border-l-red-500', text: 'text-red-700',
  },
  'All': {
  ...
  'Fee Dues': {
    ...
    cardBg: 'bg-amber-50/60', borderL: 'border-l-amber-500', text: 'text-amber-700',
  },
  'Exams': {
    code: 'Exams', name: 'Exams',
    chipActive: 'bg-rose-600 text-white border-rose-600',
    pill: 'bg-rose-50 text-rose-700 border-rose-300',
    cardBg: 'bg-rose-50/60', borderL: 'border-l-rose-500', text: 'text-rose-700',
  },
  'Scholarships': {
    ...
    cardBg: 'bg-green-50/60', borderL: 'border-l-green-500', text: 'text-green-700',
  },
  'Internship': {
    ...
    cardBg: 'bg-purple-50/60', borderL: 'border-l-purple-500', text: 'text-purple-700',
  },
  'Annual Day': {
    ...
    cardBg: 'bg-pink-50/60', borderL: 'border-l-pink-500', text: 'text-pink-700',
  },
  'Functions': {
    ...
    cardBg: 'bg-fuchsia-50/60', borderL: 'border-l-fuchsia-500', text: 'text-fuchsia-700',
  },
  'Admission Ticket': {
